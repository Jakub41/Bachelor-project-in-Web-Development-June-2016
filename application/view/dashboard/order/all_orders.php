						...
						<div class="row">
							<div class="col-sm-12">
								<div class="page-header">
									...
									<div class="description">Display Order</div>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-8 col-md-offset-2">
								<div class="box border blue">
									<div class="box-title">
										<h4><i class="fa fa-table"></i>Display Order</h4>
										<div class="tools">
										...
										<table class="table table-striped">
											...
											foreach($all_orders as $row){?>
											  ...
											  <tr>
												...
												<td>
<a class="btn btn-warning" href="<?php echo URL."order/confirm_order/".$row->order_ID."";?> ">Confirm</a>
									</td>
												<td>									
